...
const Blogs = () => {
  const [Public_Radio, setSelectedRadio] = usePersistentState('Public_Radio', '');
  const [Public_Range, setSelectedRange] = usePersistentState('Public_Range', 0);
            ...
            <div  className="absolute inset-12">
              ...
              <div className="text-center">
                <p className="text-gray-700 text-base md:text-xl xl:text-2xl font-semibold mt-6 mb-6 px-10 lg:px-40">
                  Which type of public transportation you often use ?
                </p>
                <div class="leading-tight font-semibold">
                  <label class="inline-flex items-center space-x-2">
                      <input type="radio" name="Public_Radio" class="ml-1" value="City-Metro" checked={Public_Radio === 'City-Metro'} onChange={handleRadioChange}/> 
                      City-Metro
                  </label>
                  <label class="inline-flex items-center space-x-2">
                      <input type="radio" name="Public_Radio" class="ml-5" value="Bus" checked={Public_Radio === 'Bus'} onChange={handleRadioChange}/> 
                      Bus
                  </label>
                  <label class="inline-flex items-center space-x-2">
                      <input type="radio" name="Public_Radio" class="ml-5" value="Train" checked={Public_Radio === 'Train'} onChange={handleRadioChange}/> 
                      Train
                  </label>
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col items-center mt-8">
                  ...
                  <span className="mt-2 text-gray-700">{Public_Range} kms</span>
                  <style jsx>{`
                    /* Custom Styles */
