...
const styles = StyleSheet.create({
  ...
  row: {
    flexDirection: 'row', // Display sections in a row
    flexWrap: 'wrap', // Allow sections to wrap to the next row if needed
    justifyContent: 'space-between', // Evenly distribute sections along the row
  },
  section: {
    width: '45%', // Adjust the width to fit two sections in a row with spacing
    marginBottom: 10,
  ...
  icon: {
    marginRight: 20, // Add some space between icon and text
    color:'black',
  },
...
const MyDocument = ({ session }) => {
  ...
  <Page style={styles.page} size="A4" orientation="portrait" >
    ...
    <Text style={styles.subtitle}>    
        ...
        <Svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{width:20,height:20}}>
          ...
          <Text style={styles.listItemText}>{t.username}</Text>
        </View>
        <View style={styles.listItem}>
        <Svg aria-hidden="true" fill="none" viewBox="0 0 45 45" stroke="currentColor" style={{width:20,height:20}}>
                <Path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M24.155 8.78099L24.33 8.94499L37.402 21.787L36 23.213L34.2 21.445L34.201 35C34.201 36.054 33.385 36.918 32.35 36.994L32.201 37H12.201C11.147 37 10.283 36.184 10.206 35.149L10.201 35L10.2 21.446L8.402 23.213L7 21.787L20.058 8.95799C21.171 7.82199 22.966 7.75899 24.155 8.78099ZM21.569 10.285L21.473 10.372L12.2 19.481L12.201 35L17.2 34.999L17.201 25C17.201 23.946 18.017 23.082 19.052 23.005L19.201 23H25.201C26.255 23 27.119 23.816 27.196 24.851L27.201 25L27.2 34.999L32.201 35L32.2 19.48L22.901 10.344C22.537 9.98699 21.969 9.96499 21.569 10.285ZM25.201 25H19.201L19.2 34.999H25.2L25.201 25Z"/>
          </Svg>              
          <Text style={styles.text}>Residency:</Text>
          <Text style={styles.listItemText}>{t.residency}</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
      <Svg aria-hidden="true" fill="none" viewBox="0 0 35 35" stroke="currentColor" style={{width:20,height:20}}>
        ...
        <View style={styles.listItem}>
          ...
          <Text style={styles.listItemText}>{t.flight_trip_type}</Text>
        </View>
        <View style={styles.listItem}>
      ...
      <View style={styles.section}>
      <Svg aria-hidden="true" fill="black" viewBox="0 0 35 35" stroke="currentColor" style={{width:20,height:20}}>
        ...
        <View style={styles.listItem}>
          ...
          <Text style={styles.listItemText}>{t.public_transport_type}</Text>
        </View>
        <View style={styles.listItem}>
      ...
      <View style={styles.section}>
      <Svg aria-hidden="true" fill="black" viewBox="0 0 508 508" stroke="currentColor" style={{width:20,height:20}}>
        ...
        <View style={styles.listItem}>
          <Text style={styles.text}>Engine Type:</Text>
          <Text style={styles.listItemText}>{t.motorbike_engine_type}</Text>
        </View>
        <View style={styles.listItem}>
      ...
      <Svg aria-hidden="true" fill="black" viewBox="0 0 508 508" stroke="currentColor" style={{width:20,height:20}}>
        ...
        <View style={styles.listItem}>
          <Text style={styles.text}>Transport Type:</Text>
          <Text style={styles.listItemText}>{t.self_transport_type}</Text>
        </View>
        <View style={styles.listItem}>
