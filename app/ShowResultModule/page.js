...
export default function show_result_module() {
  ...
  return (        
    ...
    //         <h1 className='text-center font-extrabold text-2xl font-mono'><u>Your Carbon Footprint</u></h1>
            

    //         {resultData.map((t, index) => (
    //             <div key={index}>

    //                 <p><b>Name : </b>{t.username}</p>
    //                 <p><b>Residency : </b>{t.residency}</p>

    //                 <fieldset className="h-auto w-2/4 border-t border-r border-b border-black">
    //                     <legend className="text-lg font-bold ml-20">Flight Emission</legend>
    ...
    //                     <fieldset className="h-auto w-2/4 border-t border-l border-b border-black ml-auto">
    //                         <legend className="text-lg font-bold ml-20">Public Transport Emission</legend>
    ...
    //                 <fieldset className="h-auto w-2/4 border-t border-r border-b border-black">
    //                      <legend className="text-lg font-bold ml-20">Car Emission</legend>
    ...
    //                 <div className="flex justify-end">
    //                 <fieldset className="h-auto w-2/4 border-t border-l border-b border-black ml-auto">
    //                         <legend className="text-lg font-bold ml-20">Motorbike Emission</legend>
    ...
    //                 <fieldset className="h-auto w-2/4 border-t border-r border-b border-black">
    //                         <legend className="text-lg font-bold ml-20">Self Transport Emission</legend>
    ...
    //             <button className='border border-black bg-green-600'>
    //                 Generate PDF
    //             </button>
